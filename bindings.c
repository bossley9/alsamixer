...
command_enum mixer_bindings[] = {
	...
	['Q'] =           CMD_MIXER_CLOSE,
	['?'] =           CMD_MIXER_HELP,
	['i'] =           CMD_MIXER_SYSTEM_INFORMATION,
	['I'] =           CMD_MIXER_SYSTEM_INFORMATION,
	['1'] =           CMD_WITH_ARG(CMD_MIXER_SET_VIEW_MODE, VIEW_MODE_PLAYBACK),
	['2'] =           CMD_WITH_ARG(CMD_MIXER_SET_VIEW_MODE, VIEW_MODE_CAPTURE),
	['3'] =           CMD_WITH_ARG(CMD_MIXER_SET_VIEW_MODE, VIEW_MODE_ALL),
	['\t'] =          CMD_MIXER_TOGGLE_VIEW_MODE,
	['6'] =           CMD_MIXER_SELECT_CARD,
	...
	['P'] =           CMD_WITH_ARG(CMD_MIXER_PREVIOUS, 1),
	['h'] =           CMD_WITH_ARG(CMD_MIXER_PREVIOUS, 1),
	['H'] =           CMD_WITH_ARG(CMD_MIXER_PREVIOUS, 1),
	[KEY_RIGHT] =     CMD_WITH_ARG(CMD_MIXER_NEXT, 1),
	['N'] =           CMD_WITH_ARG(CMD_MIXER_NEXT, 1),
	['n'] =           CMD_WITH_ARG(CMD_MIXER_NEXT, 1),
	['l'] =           CMD_WITH_ARG(CMD_MIXER_NEXT, 1),
	['L'] =           CMD_WITH_ARG(CMD_MIXER_NEXT, 1),
  ['u'] =           CMD_WITH_ARG(CMD_MIXER_CONTROL_UP, 5),
	['d'] =           CMD_WITH_ARG(CMD_MIXER_CONTROL_DOWN, 5),
	...
	['j'] =           CMD_WITH_ARG(CMD_MIXER_CONTROL_DOWN, 1),
	['E'] =           CMD_WITH_ARG(CMD_MIXER_CONTROL_UP_LEFT, 1),
	['e'] =           CMD_WITH_ARG(CMD_MIXER_CONTROL_UP_LEFT, 1),
	['X'] =           CMD_WITH_ARG(CMD_MIXER_CONTROL_DOWN_LEFT, 1),
	['x'] =           CMD_WITH_ARG(CMD_MIXER_CONTROL_DOWN_LEFT, 1),
	['R'] =           CMD_WITH_ARG(CMD_MIXER_CONTROL_UP_RIGHT, 1),
	['r'] =           CMD_WITH_ARG(CMD_MIXER_CONTROL_UP_RIGHT, 1),
